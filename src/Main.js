...
const Portfolio = () => {
  return (
    <>
      {portfolio.slice(0, 8).map((it, idx) => {
        return (
              ...
              <div className="inner">
                ...
                <ul className="desc">
                  ...
                  <li className="prom">
                    ...
                    {it.prom.map((it, idx) => {
                      return (
                        <a href={it.lnk} target="_blank">
                          <button>{it.nme}</button>
                        </a>
                      );
                    })}
                  </li>
                  <li>
                    {it.color && <h3>{it.colorh}</h3>}
                    <ol>
                      {it.color?.map((color, idx) => {
                        return (
                          <li className="color" style={{ background: color }}>
                            {color}
                          </li>
                        );
                      })}
...
const Main = () => {
  ...
  return (
    <div className="PF">
      ...
      <div className="wm">
        <p>
          <span></span> 본 포트폴리오는 비상업적 취업지원 용도이며 React를
          이용한 반응형 페이지로 제작되었습니다.{" "}
        </p>
      </div>
      <nav className="gnb">
        <ul>
